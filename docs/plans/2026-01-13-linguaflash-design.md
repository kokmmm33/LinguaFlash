# LinguaFlash 翻译软件设计文档

## 概述

LinguaFlash 是一款简洁高效的跨平台翻译软件，支持输入翻译、截图翻译、划词翻译功能，使用本地 Ollama 和智谱 GLM 大模型作为翻译引擎。
...
- macOS：`~/Library/Application Support/com.linguaflash.app/`
- Windows：`%APPDATA%/com.linguaflash.app/`
